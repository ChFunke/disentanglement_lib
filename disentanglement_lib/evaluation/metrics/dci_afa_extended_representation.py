...
@gin.configurable(
    "dci_afa_extended_representation",
...
def compute_dci(ground_truth_data, representation_function, random_state,
                ...
                batch_size=16):
    """Computes the DCI scores after fast adaptation on an extended representation.
  ...
  """
    ...
    scores['evaluation.name'] = "dci_afa_extended_representations"
    return scores
...
def get_fast_adapted_representation_function(ground_truth_data, representation_function, random_state_for_few_labels,
    ...
    if num_labels_available == 0:
        ...
        def _fast_adapted_representation_function(x):
            ...
            representations = np.hstack((representations, adapted_dimension_encodings[:, entangled_code_dimensions[0:len(corr_factors)]]))
